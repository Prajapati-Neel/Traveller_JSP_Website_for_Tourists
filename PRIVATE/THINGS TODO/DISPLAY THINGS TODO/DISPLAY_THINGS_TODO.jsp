    ...
    <body>
       ...
       <% 
          ...
          <table border="1" cellpadding="6">
           ...
           <form action="DISPLAY_THINGS_TODO_BY_STATE.jsp" method="post">
               <tr>
            <td>
              DISPLAY  BY  STATE
            </td>
           ...
           <form action="DISPLAY_THINGS_TODO_BY_LOCATION.jsp" method="post">
               <tr>
            <td>
              DISPLAY  BY  LOCATION
            </td>
            ...
            <td>
             ...
             <td colspan="4" align="right">
              <form action="DISPLAY_ALL_THINGS_TODO.jsp" method="post">
             <input  type="submit" value="DISPLAY ALL THINGS_TODO">
            </td>
            </tr>           
            </table>
     </body>
