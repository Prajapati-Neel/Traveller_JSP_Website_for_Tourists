...
<html>
   ...
   <%!
     ...
     %>
           ...
           <form action="DELETE_HOTEL_BY_STATE.jsp" method="post">
               <tr>
            <td>
              DELETE HOTEL BY STATE
            </td>
            <td>
              SELECT STATE:-
            </td>
            ...
            <td>
              ...
              <form action="DELETE_ALL_HOTEL_BY_STATE.jsp" method="post">
               <tr>
            <td>
              DELETE ALL HOTEL BY STATE
            </td>
            <td>
              SELECT STATE:-
            </td>
            ...
            <td>
              ...
              <input type="submit" value="DELETE ALL HOTELS FROM SELECTED STATE">
           </td>
            
            </form>

               <form action="DELETE_HOTEL_BY_LOCATION.jsp" method="post">
               <tr>
            <td>
              DELETE HOTEL BY LOCATION
            </td>
            <td>
              SELECT LOCATION:-
            </td>
            ...
            <td>
              ...
              <form action="DELETE_ALL_HOTEL_BY_LOCATION.jsp" method="post">
               <tr>
            <td>
              DELETE ALL HOTEL BY LOCATION
            </td>
            <td>
              SELECT LOCATION:-
            </td>
            ...
            <td>
              ...
              <input type="submit" value="DELETE ALL HOTELS FROM SELECTED LOCATION">
           </td>
             ...
             <td colspan="4" align="center" >
              <form action="DELETE_ALL_HOTELS.jsp" method="post">
             <input  type="submit" value="DELETE ALL HOTELS">
            </td>
            </tr>           
            </table>
     </body>
